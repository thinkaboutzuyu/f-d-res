...
const face_mask_classification_model_url = `${process.env.PUBLIC_URL}/tfjs/face_mask_classification/model.json`;
  ...
  return (
    ...
    >
      <div
        ...
        className="web-cam-parent-panel"
      >
        <div
          style={{
            // ...styles.webCamPanel,
        ...
        >
          <FormGroup style={{ width: "100%", backgroundColor: "red" }}>
